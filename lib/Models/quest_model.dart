...
import 'package:sudoku/Models/daily_quest_loader.dart';
import 'package:sudoku/NavigationBar/bottom_navigation_bar.dart';
import 'package:sudoku/Pages/quest_win_page.dart';
...
class QuestModel extends StatefulWidget {
  final DateTime selectedDate;

  const QuestModel({required this.selectedDate, super.key});

  @override
  State<QuestModel> createState() => _QuestModelState();
}

class _QuestModelState extends State<QuestModel> {
  ...
  late SudokuQuestLoader _sudokuLoader;
  late Timer _timer;
  ...
  void initState() {
    ...
    _sudokuLoader = SudokuQuestLoader(
      _sudokuGrid,
      _userFilled,
      widget.selectedDate,
    );
  ...
  Future<void> _loadSudoku() async {
    await _sudokuLoader.loadSudoku(widget.selectedDate);
    setState(() {
